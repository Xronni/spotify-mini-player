...
class SpotifyMiniWindow(Gtk.Window):
    ...
    def _build_ui(self):
        ...
        self.artist_label = Gtk.Label(label="Spotify")
        ...
        self.queue_scroll.set_max_content_height(190)
    ...
    def _rebuild_queue_ui(self, order_changed=False):
        ...
        if past_tracks:
            ...
            for idx, track in enumerate(past_tracks):
                ...
                a_lbl = Gtk.Label(label=track.get("artist", "Spotify"))
